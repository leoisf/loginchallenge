...
import com.loginchallenge.core.models.Loginchallengegituserpage;
...
@Model(adaptables = {
    ...
    Loginchallengegituserpage.class,
    ComponentExporter.class
}, resourceType = "loginchallenge/components/loginchallengegituserpage")
@Exporter(name = ExporterConstants.SLING_MODEL_EXPORTER_NAME, extensions = ExporterConstants.SLING_MODEL_EXTENSION)
public class LoginchallengegituserpageImpl
    implements Loginchallengegituserpage
{
