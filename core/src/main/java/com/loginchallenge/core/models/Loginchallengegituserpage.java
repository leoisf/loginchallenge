...
/**
 * Defines the {@code Loginchallengegituserpage} Sling Model used for the {@code loginchallenge/components/loginchallengegituserpage} component.
 * 
 */
@ConsumerType
public interface Loginchallengegituserpage
    extends ComponentExporter
{


    @JsonProperty("back_button")
    String getBack_button();
