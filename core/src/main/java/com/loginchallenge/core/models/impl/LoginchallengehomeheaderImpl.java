...
import com.loginchallenge.core.models.Loginchallengehomeheader;
...
@Model(adaptables = {
    ...
    Loginchallengehomeheader.class,
    ComponentExporter.class
}, resourceType = "loginchallenge/components/loginchallengehomeheader")
@Exporter(name = ExporterConstants.SLING_MODEL_EXPORTER_NAME, extensions = ExporterConstants.SLING_MODEL_EXTENSION)
public class LoginchallengehomeheaderImpl
    implements Loginchallengehomeheader
{
